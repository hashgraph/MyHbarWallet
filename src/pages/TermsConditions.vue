...
<template>
  ...
  >
    ...
    <div class="mt-14">
      ...
      <ol class="mt-6 leading-5">
        <li class="mx-6">
          1. {{ $t("TermsAndConditions.redistribution.paragraph1") }}
        </li>

        <li class="mx-6 mt-1">
          2. {{ $t("TermsAndConditions.redistribution.paragraph2") }}
        </li>

        <li class="mx-6 mt-1">
          3. {{ $t("TermsAndConditions.redistribution.paragraph3") }}
        </li>
