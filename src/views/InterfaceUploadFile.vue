...
export default createComponent({
    ...
    setup(props: object, context: SetupContext) {
        ...
        async function handleUploadSubmit(accept: boolean): Promise<void> {
            ...
            return handleUpload(state.uploadBytes as Uint8Array);
        }
        ...
        function estimateFee(): void {
            ...
            state.estimatedFee =
                ...
                ((((state.uploadBytes as Uint8Array).byteLength % MAX_CHUNK_LENGTH) / 1000) * 0.55 + 1.05);
        ...
        async function handleUpload(file: Uint8Array): Promise<void> {
            ...
            for (let i = 0; i < state.uploadProgress.totalChunks; i += 1) {
