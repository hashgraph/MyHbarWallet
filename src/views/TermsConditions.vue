    ...
    <CirclePage>
        <div class="wrap">
            ...
            <div class="text-content">
                ...
                <p>
                    Always backup your keys: MyHbarWallet is not a "web wallet".
                ...
                <p>
                    Translations of MyHbarWallet: The English version of
                    MyHbarWallet is the official text.
                </p>
                ...
                <div>
                    <p>
                        "<strong>License</strong>" shall mean the terms and
                        conditions for use, reproduction, and distribution as
                        defined by Sections 1 through 9 of this document.
                    </p>

                    <p>
                        "<strong>Licensor</strong>" shall mean the copyright
                        owner or entity authorized by the copyright owner that
                        is granting the License.
                    </p>

                    <p>
                        "<strong>Legal Entity</strong>" shall mean the union of
                        the acting entity and all other entities that control,
                        are controlled by, or are under common control with that
                        entity. For the purposes of this definition,
                        "<strong>control</strong>" means (i) the power, direct
                    ...
                    <p>
                        ...
                        shall mean an individual or Legal Entity exercising
                        permissions granted by this License.
                    </p>

                    <p>
                        "<strong>Source</strong>" form shall mean the preferred
                        form for making modifications, including but not limited
                        to software source code, documentation source, and
                        configuration files.
                    </p>

                    <p>
                        "<strong>Object</strong>" form shall mean any form
                    ...
                    <p>
                        "<strong>Work</strong>" shall mean the work of
                    ...
                    <p>
                        "<strong>Derivative Works</strong>" shall mean any work,
                        whether in Source or Object form, that is based on (or
                    ...
                    <p>
                        "<strong>Contribution</strong>" shall mean any work of
                        authorship, including the original version of the Work
                        and any modifications or additions to that Work or
                        ...
                        "<strong>submitted</strong>" means any form of
                        ...
                        as "<strong>Not a Contribution.</strong>"
                    </p>

                    <p>
                        "<strong>Contributor</strong>" shall mean Licensor and
                        any individual or Legal Entity on behalf of whom a
                ...
                <p>
                    <strong
                        ><a name="copyright"
                            >2. Grant of Copyright License</a
                        ></strong
                ...
                <p>
                    <strong
                        ><a name="patent">3. Grant of Patent License</a></strong
                    >. Subject to the terms and conditions of this License, each
                    Contributor hereby grants to You a perpetual, worldwide,
                ...
                <p>
                    <strong
                        ><a name="redistribution">4. Redistribution</a></strong
                ...
                <ol>
                    ...
                    <li>
                        If the Work includes a "<strong>NOTICE</strong>" text
                        file as part of its distribution, then any Derivative
                        Works that You distribute must include a readable copy
                        of the attribution notices contained within such NOTICE
                ...
                <p>
                    <strong
                        ><a name="contributions"
                            >5. Submission of Contributions</a
                        ></strong
                ...
                <p>
                    ...
                    Licensor, except as required for reasonable and customary
                ...
                <p>
                    ...
                    or out of the use or inability to use the Work (including
                ...
                <p>
                    ...
                    only on Your own behalf and on Your sole responsibility, not
