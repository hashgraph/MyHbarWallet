...
export default createComponent({
    ...
    setup(props: object, context: SetupContext) {
            ...
            switch (which) {
                case AccessHardwareOption.Ledger:
                    ...
                    try {
                        ...
                        const { LedgerNanoS } = await (import("../wallets/hardware/LedgerNanoS" /* webpackChunkName: "hardware" */) as
                            Promise<typeof import("../wallets/hardware/LedgerNanoS")>);
        ...
        function handleDownloadKeystoreSubmit(): void {
            ...
            context.root.$el.removeChild(keyStoreLink.value);
        }
