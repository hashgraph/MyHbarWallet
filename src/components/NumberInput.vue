<template>
    <div class="number-input" :class="classObject">
        <label>
        ...
        <div class="decorations">
            <span v-if="suffix != null" class="suffix">
                {{ suffix }}
            </span>
...
export default createComponent({
    ...
    props: {
        ...
        value: (Number as unknown) as PropType<number>,
        min: ({ type: Number, default: 0 } as unknown) as PropType<number>,
