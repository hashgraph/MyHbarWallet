<template>
  <div>
    <Switch v-model="isOpen" label="Max Transaction Fee" />

    <HbarInput v-model="value" medium-font :disabled="!isOpen" class="mt-3" />

    <div class="text-sm mt-2 text-squant italic">Lorem ipsum hint text.</div>
  </div>
</template>
