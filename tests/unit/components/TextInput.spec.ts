...
describe("TextInput.vue", (): void => {
    ...
    it("renders", (): void => {
        ...
        expect(wrapper).toMatchInlineSnapshot(`
            <div class="text-input"><label class="label-container">
                <!----> <span class="input-container"><!----> <span class="input-wrapper"><div class="flex-container"><div class="text-flex-item"><input autocomplete="on" spellcheck="true" type="text"></div> <div class="deco-flex-item"><!----></div></div></span>
                <!----></span></label>
              <!---->
              <!---->
            </div>
    ...
    it("renders validation indicator", (): void => {
        ...
        expect(wrapper).toMatchInlineSnapshot(`
            <div class="text-input is-multiline"><label class="label-container">
                <!----> <span class="input-container"><!----> <span class="input-wrapper"><div class="flex-container"><div class="text-flex-item"><textarea rows="8" class="text-area"></textarea></div> <div class="deco-flex-item"><span class="decorations"><svg height="24" width="24" viewBox="0 0 24 24" class="checkmark is-valid"><path d="M12 2C6.5 2 2 6.5 2 12S6.5 22 12 22 22 17.5 22 12 17.5 2 12 2M10 17L5 12L6.41 10.59L10 14.17L17.59 6.58L19 8L10 17Z"></path></svg></span></div>
            </div></span>
            <!----></span></label>
            <!---->
            <!---->
