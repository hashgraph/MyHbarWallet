            ...
            <footer>
              ...
              <div class="wrapper">
                <div class="links"><a href="#/" class="link router-link-exact-active router-link-active">
                    Privacy
                  </a> <a href="#/" class="link router-link-exact-active router-link-active">
                    Terms
                  </a> <a href="https://github.com/hashgraph/MyHbarWallet/commit/placeholderhash" target="_blank" class="link">
                    v1.1.1+placeholderhash
                  </a></div>
                <div class="copyright"><a href="https://www.coingecko.com/" target="_blank" class="link">
                ...
                <div></div>
                <div class="social">
                  <!----> <a href="https://twitter.com/myhbarwallet?lang=en" rel="noopener" target="_blank" class="social-link"><svg height="24" width="24" viewBox="0 0 24 24" class="social-icon">
                    ...
                    </svg></a> <a href="https://www.github.com/hashgraph/MyHbarWallet" rel="noopener" target="_blank" class="social-link"><svg height="24" width="24" viewBox="0 0 24 24" class="social-icon">
                    ...
                    </svg></a> <a href=" https://medium.com/myhbarwallet" rel="noopener" target="_blank" class="social-link"><svg height="24" width="24" viewBox="0 0 24 24" class="social-icon">
