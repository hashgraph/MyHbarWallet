    ...
    it("renders closed, busy", (): void => {
        ...
        expect(wrapper).toMatchInlineSnapshot(`
            <div class="create-with-keystore-file">
              ...
              <!---->
              <div class="btn-container"><button type="submit" disabled="disabled" class="btn busy"><svg width="24" height="24" viewBox="0 0 24 24" class="spinner mdi-spin">
                    <path d="M12,4V2A10,10 0 0,0 2,12H4A8,8 0 0,1 12,4Z"></path>
                  </svg> <svg width="24" height="24" viewBox="0 0 24 24" class="icon">
                    <path d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z"></path>
                  </svg></button></div>
              </form>
              <p class="footer"><span class="important">DO NOT FORGET</span> to save your password. You will need this <span class="important">Password + Keystore</span> File to unlock your wallet.</p>
