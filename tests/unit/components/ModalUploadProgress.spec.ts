...
describe("ModalUploadProgress.vue", (): void => {
    ...
    it("renders, in progress, 0%", async(): Promise<void> => {
        ...
        expect(wrapper).toMatchInlineSnapshot(`
            <transition-stub name="fade" not-closeable="" listeners="[object Object]">
                    ...
                    <div class="main">
                      ...
                      <div class="content-container">
                        <div class="modal-upload-progress">
                          ...
                          <div class="upload-subtext-try-again">
                            Try again?
                          </div>
                          <div class="visual-container"><svg width="120" height="120" viewBox="0 0 24 24" class="icon">
                          ...
                          <!---->
                          <div class="button-container"><button type="submit" class="button outline compact danger">
                              <!----> <span>Cancel</span>
                              <!---->
