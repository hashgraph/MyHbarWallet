...
describe("ModalUploadProgress.vue", (): void => {
    ...
    it("renders, in progress, 0%", (): void => {
        ...
        expect(wrapper).toMatchInlineSnapshot(`
            <div aria-modal="true" role="dialog" transition="modal-fade" class="modal-background" not-closeable="" listeners="[object Object]">
              <div class="modal">
                <!---->
                <!---->
                <div class="main">
                  ...
                  <div class="content-container">
                    <div class="modal-upload-progress">
                      ...
                      <div class="visual-container"><svg height="120" width="120" viewBox="0 0 24 24" class="icon mdi-slow-spin">
                ...
                <div class="main">
                  ...
                  <div class="content-container">
                    <div class="modal-upload-progress">
                      ...
                      <div class="visual-container"><svg height="120" width="120" viewBox="0 0 24 24" class="icon">
