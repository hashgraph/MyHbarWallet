...
describe("InterfaceNavigation", (): void => {
    ...
    it("renders", (): void => {
        ...
        expect(wrapper).toMatchInlineSnapshot(`
            <div>
              <div class="side-nav-top menu-closed"><img alt="" src="../assets/myhbarwallet-logo.svg" class="logo"> <svg height="24" width="24" viewBox="0 0 24 24" class="close">
              ...
              <nav class="menu-closed">
                <div class="nav-section">
                  <div class="nav-section-header"><svg height="24" width="24" viewBox="0 0 24 24" class="icon" alt="">
                    ...
                    </svg> <span class="nav-title">Crypto</span> <svg height="24" width="24" viewBox="0 0 24 24" class="indicator">
                ...
                <div class="nav-section">
                  <div class="nav-section-header"><svg height="24" width="24" viewBox="0 0 24 24" class="icon" alt="">
                    ...
                    </svg> <span class="nav-title">Files</span> <svg height="24" width="24" viewBox="0 0 24 24" class="indicator">
                      <path d="M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z"></path>
                    </svg></div>
                  <!---->
                </div>
